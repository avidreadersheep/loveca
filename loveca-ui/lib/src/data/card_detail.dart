...
class CardDetailView {
  ...
  /// |---|---|
  /// | **Phase 4（同期）** | 他端末で新しいマスタを使って作ったデッキが同期で降ってくる。`Deck.masterDataVersion`（決定 D35）と決定 D35 は**まさにこれを検出するため**にある。M4 のデッキペインは未知の刷りを「表示できないカード」として読み取り専用で出しており、**そこから詳細を開けるようにした瞬間に到達する** |
