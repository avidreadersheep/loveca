...
/// デッキペインの幅（★M4 で実測して決める / 未決 U8）。
///
/// ★★ 暫定の 320 は見積りだった（決定 D61 の根拠 (b)）★★
/// 実測の手順と値は `docs/UI設計メモ.md` §9-6 /
/// `test/ui/deck_pane_width_test.dart`。
const double kDeckPaneMinWidth = 320;
// ★M4 の実測（ / 2026-08-24）
//   ・溢れない下限: 151 論理px（★テスト用フォント。**読める幅ではない**）
//   ・採用値 320 のとき、行の名前に残る幅: 177 論理px（★固定幅の引き算なのでフォントに依らない）
